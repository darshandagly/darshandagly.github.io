...
module.exports = function(){
  ...
  var scale = d3version3.scale.linear(),
    shape = "rect",
    shapeWidth = 15,
    shapeHeight = 15,
    shapeRadius = 10,
    ...
    labels = [],
    useClass = false,
    labelFormat = d3version3.format(".01f"),
    labelOffset = 10,
    labelAlign = "middle",
    labelDelimiter = "to",
    orient = "vertical",
    path,
    legendDispatcher = d3version3.dispatch("cellover", "cellout", "cellclick");
  ...
  d3version3.rebind(legend, legendDispatcher, "on");
...
module.exports =  function(){
  ...
  var scale = d3version3.scale.linear(),
    ...
    function legend(svg){
      ...
      var maxH = d3version3.max(shapeSize, function(d){ return d.height + d.y; }),
      maxW = d3version3.max(shapeSize, function(d){ return d.width + d.x; });
      ...
      if (orient === "vertical"){
        ...
        cellTrans = function(d,i) {
            var height = d3version3.sum(shapeSize.slice(0, i + 1 ), function(d){ return d.height; });
        ...
        cellTrans = function(d,i) {
            var width = d3version3.sum(shapeSize.slice(0, i + 1 ), function(d){ return d.width; });
...
module.exports = function(){
  ...
  var scale = d3version3.scale.linear(),
    ...
    function legend(svg){
      ...
      var maxH = d3version3.max(shapeSize, function(d){ return d.height; }),
      maxW = d3version3.max(shapeSize, function(d){ return d.width; });
